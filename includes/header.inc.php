        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/tutorial.php?page=tutorial">Tutorials</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/chat.php?page=chat">Chat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/template_upload.php?page=templates">Templates</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="pages/php.php">Php</a></li>
                            <li><a class="dropdown-item" href="pages/asp_net.php">Asp .net</a></li>
                            <li><a class="dropdown-item" href="pages/php.php">c programming</a></li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu " style="margin-left:-50px;">
                            <li><a class="dropdown-item" style="font-family : 'Roboto' ,'san-sarif' ; font-weight:800;"
                                    href="
                                    pages/profile.php?pic=jkl"> <span><i class="bi bi-person-fill"></i>
                                    </span> Profile</a></li>
                            ...
                            <li><a class="dropdown-item text-danger  "
                                    style="font-family : 'Roboto' ,'san-sarif' ; font-weight:800;"
            ...
            if($_SESSION['role']=="tutor"){
                ?>
                    <div class="div mx-3">
                        <a href="pages/dashboard.php" class="btn  border  ">Dashboard</a>
                    </div>
                    <?php
                    }
                    ?>
