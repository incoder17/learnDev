         ...
         <section class="py-5 text-center container">
             <div class="row py-lg-5">
                 <div class="col-lg-6 col-md-8 mx-auto">
                     ...
                     <p class="lead text-muted">PHP (recursive acronym for PHP: Hypertext Preprocessor ) is a
                         widely-used
                         open source general-purpose scripting language that is especially suited for web development
                         and
                         can be embedded into HTML.</p>
                     <a href="https://www.php.net/manual/en/class.domdocument.php"
                         class=" btn btn-primary  btn btn-primary" style="
                        border-radius:none !important; "><i class="bi bi-book-half"></i> Read Documents</a>
...
FROM playlist WHERE language='php   '";
